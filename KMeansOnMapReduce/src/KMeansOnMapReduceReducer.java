...
public class KMeansOnMapReduceReducer extends MapReduceBase implements Reducer<LongWritable, FloatArrayWritable, LongWritable, FloatArrayWritable> {
	...
	public void reduce(LongWritable key, Iterator<FloatArrayWritable> values, OutputCollector<LongWritable, FloatArrayWritable> output, Reporter reporter)
		...
		// Remove last value and use it as size
		int size = (int) sum.pop();
